...
if exist "%CD%\..\BrainstormSessions\bin\Debug\netcoreapp3.0\Logs\Example.log" xcopy "%CD%\..\BrainstormSessions\bin\Debug\netcoreapp3.0\Logs\Example.log" "%CD%\Logs" /Y

set "myLogFile=%CD%\Logs\Example.log"
set "outputFileName=log_report.%fullstamp%.txt"

if exist "..\LogParser" cd ..\LogParser
if exist "..\..\..\..\LogParser" cd ..\..\..\..\LogParser
...
if exist "%CD%\..\BrainstormSessions\Logs\LogReports" move /y %CD%\%outputFileName% %CD%\..\BrainstormSessions\Logs\LogReports else ROBOCOPY %CD% %CD%\..\BrainstormSessionsLogReports %outputFileName% /MOV